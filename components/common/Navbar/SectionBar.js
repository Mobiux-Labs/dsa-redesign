  ...
  return (
    <div className="cursor-pointer flex flex-col mr-[45px] ml-[20px]">
      ...
      <div className="flex items-center mt-[12px]">
        ...
        {/* Dropdown menu */}
        <div id="regions-dropdown" className="hidden bg-white p-3 shadow-md">
...
function SectionButton({ imgSrc, name, link }) {
  return (
    <div className="cursor-pointer flex flex-col mr-[45px]">
